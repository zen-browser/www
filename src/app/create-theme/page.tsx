...
export default function CreateThemePage() {
  ...
  const [primaryColor, setPrimaryColor] = useState(defaultStyles.primaryColor.dark);
  const [secondaryColor, setSecondaryColor] = useState(defaultStyles.secondaryColor.dark);
  const [tertiaryColor, setTertiaryColor] = useState(defaultStyles.tertiaryColor.dark);
  const [colorsBorder, setColorsBorder] = useState(defaultStyles.colorsBorder.dark);
  const [dialogBg, setDialogBg] = useState(defaultStyles.dialogBg.dark);
