				...
				<div className="mx-auto flex w-full flex-col justify-center p-10 md:p-20 lg:w-1/2 lg:p-0 2xl:w-1/3">
					{(hasDownloaded && (
						<div className="flex flex-col items-center justify-center">
							...
							<div className="mx-auto mt-5 flex items-center justify-between font-bold">
							...
							{selectedPlatform === "MacOS" && (
								<div className="mt-12 flex flex-col items-start justify-between rounded-md border bg-background p-5">
						...
						{platform === null && (
							<FormField enter={platform === null} out={platform !== null}>
								...
								<div
									...
									className={ny(
										"mb-2 flex cursor-pointer select-none items-center rounded-lg border bg-background px-4 py-3",
										selectedPlatform === "Windows" ? "border-blue-400" : "",
									)}
								>
									<Checkbox checked={selectedPlatform === "Windows"} />
									<i className="devicon-windows8-original ml-3 rounded-lg border border-blue-400 p-2"></i>
								...
								>
									...
									<i className="devicon-linux-plain ml-3 rounded-lg border border-yellow-400 p-2"></i>
								...
								>
									...
									<i className="devicon-apple-original ml-3 rounded-lg border border-purple-400 p-2"></i>
