...
export default function ThemePage({ theme }: { theme: ZenTheme }) {
  ...
  return (
    <div className="mt-24 lg:mt-56 flex-col lg:flex-row flex mx-auto items-start relative">
      <div className="flex flex-col relative lg:sticky w-md h-full p-5 lg:p-0 lg:pr-5 mr-5 w-full md:max-w-sm">
        <div
      ...
      <div className="flex flex-col lg:border-l lg:min-h-96 pl-10 max-w-xl lg:min-w-96 w-full">
